...
const BEMApp = {
    ...
    renderStatistic() {
        ...
        const totalDivisi = divisi?.length || profil?.statistik?.divisi || 8;
        const totalProker = proker?.length || profil?.statistik?.programKerja || 35;
        const totalPengurus = pengurus?.length || profil?.statistik?.pengurus || 60;
